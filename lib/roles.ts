...
export type Permission = 'deal:create' | 'deal:edit' | 'deal:view' | 'deal:score' | 'deal:adjust' | 'decision:make' | 'decision:request-info' | 'policy:manage' | 'users:manage' | 'org:manage' | 'reports:view' | 'audit:export' | 'consent:request' | 'consent:manage' | 'consent:view' | 'payments:configure' | 'platform:manage';

export const permissions: Record<Role, Permission[]> = {
  DEALER_STAFF: ['deal:create', 'deal:edit', 'deal:view', 'deal:score', 'deal:adjust', 'consent:request', 'consent:view'],
  UNDERWRITER: ['deal:create', 'deal:edit', 'deal:view', 'deal:score', 'deal:adjust', 'decision:make', 'decision:request-info', 'reports:view', 'audit:export', 'consent:request', 'consent:view'],
